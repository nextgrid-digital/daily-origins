...
export function ProductCard({
  ...
  return (
    <Link
      ...
      prefetch={true}
      className="group flex items-center gap-4 rounded-2xl border border-line bg-white p-3 transition-all duration-200 hover:border-stone-dark hover:shadow-sm"
    >
      <div className="relative h-16 w-16 flex-none overflow-hidden rounded-xl border border-line bg-stone">
        <Image
      ...
      <div className="min-w-0 flex-1">
        ...
        <p className="mt-1 truncate text-xs text-ink-soft">{meta.tagline}</p>
      </div>

      <Price
        className="flex-none self-start text-xs font-medium text-ink-soft"
